...
(function(cb) {
    ...
    fa.prototype = {
        ...
        Rd: function(a) {
            ...
            function c(a) {
                ...
                if (null == a)
                    throw new l(null);
                d.ta = new WebSocket(b + "?token=" + a, {headers:{origin: "https://html5.haxball.com"}, agent: proxyAgent});
                ...
                ;
                d.ta.onerror=function(err){d.xd(!0);debug && console.error(err)};
        ...
        Lg: function(a) {
            var b = a.Lb(), c = H.hi(a.Ka(a.B())), d, e, f;
            try {
    ...
    C.b = !0;
    C.ug = function(a, b) {
        var c = a.getUint8(b), d, e, f, h, m, q = b;
        if (0 == (c & 128))
            ++b;
        else if (192 == (c & 224))
            d = a.getUint8(b + 1),
    ...
    y.Th = function(a) {
        ...
        A.Rc = function(a) {
            a = y.hh(a, null != A.jb);
            y.Ih = '<p>Room Link: <a href="' + a + '">' + a + "</a></p>";
            var b = D.onRoomLink;
            null != b && b(a)
        }
        ;
