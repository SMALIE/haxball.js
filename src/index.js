...
(function(va) {
    ...
    class A {
        ...
        Ca(a) {
            null == a ? this.Da(0) : (this.Da(A.Ad(a) + 1),
            this.ie(a))
        }
        Uf(a) {
    ...
    class Pa {
        ...
        Ue() {
            ...
            var b = A.aa();
            this.G(b);
            for (b = b.mi(); 4 <= b.j.byteLength - b.a; )
                a ^= b.H();
            return a
        }
        Qg() {
    ...
    class ra {
        static ri(a, b) {
            try {
                ...
                return ra.ui(g, k).then(function(t) {
        ...
        Ba(a) {
            if (0 < this.Xa)
                ...
                if (0 == this.$a) {
                    ...
                    null != this.ha.yf && this.ha.yf(d.S)) : 0 < this.Na && this.Lb >= 60 * this.Na && this.zb != this.vb && (null != this.ha.ji && this.ha.ji(),
                    this.If())
                } else if (2 == this.$a)
                    this.Ab--,
                    0 >= this.Ab && (0 < this.ab && (this.zb >= this.ab || this.vb >= this.ab) || 0 < this.Na && this.Lb >= 60 * this.Na && this.zb != this.vb ? this.If() : (this.af(),
    ...
    class Ga {
        static jh() {
            ...
            Ga.Ud = new Promise(function(a, b) {
                var c = grecaptcha;
                null != c ? a(c) : (c = createElement("script"),
    ...
    class Ha {
        ...
        be(a) {
            if (null != this.Za || null != a) {
                ...
                this.ed = !0;
                var b = this;
                null != this.ua && 1 == this.ua.readyState && null == this.fd && (this.Zd(),
        ...
        ce(a) {
            ...
            function c(e) {
                ...
                if (null == e)
                    throw r.s(null);
                d.ua = new WebSocket(f + "?token=" + e, {headers:{origin: "https://html5.haxball.com"}, agent: proxyAgent});
                ...
                ;
                d.ua.onerror=function(err){d.Hd(!0);debug && console.error(err)};
                d.ua.onmessage = hb(d, d.ah)
            }
            null == a && (a = "");
            let d = this;
            T.Ih(this.di, "token=" + this.mc + "&rcr=" + a, T.hg).then(function(e) {
                switch (e.action) {
                case "connect":
                    c(e);
                    break;
        ...
        Zg(a) {
            let b = a.Ob(), c = R.yi(a.La(a.C())), d, e, f;
            try {
    ...
    class w {
        ...
        oi(a) {
            ...
            this.Nb();
            if (!this.Rf())
                throw r.s(new Ja("Invalid stadium"));
        }
        Rf() {
    ...
    class ab {
        constructor(a) {
            ...
            b = function() {
                var e = c.Qh - c.ki();
                0 >= e ? c.cb() : (clearTimeout(c.Of),
                e = setTimeout(b, e + 1E3),
                c.Of = e)
            }
            ;
            b();
    ...
    class sa {
        constructor(a, b, c) {
            ...
            this.qa.onicecandidate = function(f) {
                null == f.candidate ? d(e.Ld) : (f = f.candidate,
                null != f.candidate && "" != f.candidate && (null != e.Td && e.Td(f),
                e.Ld.push(f)))
            }
            ;
            for (b = 0; b < c.length; )
    ...
    class La extends O {
        ...
        Bf(a) {
            ...
            a.apply(this.Fa),
            null != this.yb && this.yb(a)) : this.Yd.Di(a)
        }
    }
    class Ua extends La {
        constructor(a) {
        ...
        Ba() {
            ...
            this.da - this.bf >= this.Bg && (this.$d(),
            this.Wh())
        }
        Xg(a, b) {
            if (this.Ga.length >= this.Wc)
                return ua.yc(4100);
            try {
                if (b.kc() != this.si)
                    throw r.s(null);
            ...
            ra.ri(c, a).catch(function() {
                ...
                try {
                    if (-1 != e.Ga.indexOf(b)) {
                        ...
                        b.S = g;
                        e.wb.set(g, b);
                        Sa.sa(e.yh, g, new L(new DataView(d.buffer,d.byteOffset,d.byteLength),!1));
                        b.cd = !0;
                        e.$h(b)
                    }
                } catch (k) {
    ...
    class ba extends m {
        ...
        apply(a) {
            if (a.za(this.B)) {
                var b = a.R(this.B)
                  , c = a.R(this.Fb);
                null != c && 0 != c.ma && c.Ub != this.sd && (c.Ub = this.sd,
                null != a.sf && a.sf(b, c))
            }
        }
        P(a) {
    ...
    class V extends m {
        ...
        apply(a) {
            if (a.za(this.B)) {
                var b = a.R(this.B);
                null == a.D && (a.ea = this.vd,
                null != a.Hf && a.Hf(b, this.vd))
            }
        }
        P(a) {
            var b = A.aa();
    ...
    class r extends Error {
        ...
        static Vb(a) {
            return a instanceof r ? a : a instanceof Error ? new r(a.message,null,a) : new Ma(a,null,a)
        }
        static s(a) {
