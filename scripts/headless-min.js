...
(function(va) {
    ...
    class Ha {
        ...
        Hd(a) {
            ...
            let b = this;
            a && (this.Uh = window.setTimeout(function() {
                b.ce()
    ...
    class F {
        static sh() {
            ...
            ia.Sg().then(function(a) {
                ...
                window.parent.HBInit = F.fi;
                let a = window.parent.onHBLoaded;
                null != a && a()
            });
            F.Vh = window.document.getElementById("roomlink")
        }
        static bi(a, b, c) {
        ...
        static fi(a) {
            ...
            D.Yc = function(h) {
                h = F.uh(h, null != D.lb);
                F.Vh.innerHTML = '<p>Room Link: <a href="' + h + '">' + h + "</a></p>";
                {
                    let n = J.onRoomLink;
                    null != n && n(h)
                }
    ...
    class sa {
        ...
        gi() {
            ...
            this.ee = window.setTimeout(hb(this, this.dh), a)
        }
        async Gg(a, b) {
