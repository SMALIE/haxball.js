(function (cb) {
  ...
  function Na(a) {
    ...
    for (var d = this.hb; a < d.length; ) {
      ...
      e.onmessage = function (a) {
        b.Ec &&
          ((b.Bf = window.performance.now()), null != b.$e && b.$e(a.data));
      };
      e.onclose = function () {
        b.bb();
      };
  ...
  fa.prototype = {
    ...
    Pd: function (a) {
      ...
      var c = this;
      this.dc = a;
      null == this.mf && (b(), (this.mf = window.setTimeout(b, 1e3)));
    },
    Rd: function (a) {
      function b(a) {
        a = a.sitekey;
      ...
      null == a && (a = '');
      var d = this;
      F.vh(this.Rh, 'token=' + this.$c + '&rcr=' + a, F.Uf)
        .then(function (a) {
          switch (a.action) {
            case 'connect':
              c(a);
    ...
    xd: function (a) {
      ...
      a &&
        (this.Hh = window.setTimeout(function () {
          b.Rd();
  ...
  y.Ph = function (a, b, c) {
    null == y.Vc &&
      ((y.Vc = window.document.getElementById('recaptcha')),
      (y.Ch = a.render(y.Vc, {
        sitekey: b,
        callback: function (a) {
          null != y.Kd && y.Kd(a);
  ...
  J.prototype = {
    ...
    Oe: function () {
      ...
      this.Za = 0;
      for (
        var b = this.fa.w, c = this.ia.w, d = 0, e = this.fa.Xc ? b.length : 1;
        d < e;
  ...
  n.prototype = {
    ...
    ai: function (a) {
      ...
      this.I = [];
      c = a.B();
      for (d = 0; d < c; ) ++d, (e = new z()), e.qa(a, this.u), this.I.push(e);
      this.Y = [];
      c = a.B();
